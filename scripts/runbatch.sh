...
./run.sh -p iron -e '1E5 1E7' -m -2.8 -z '0. 5.' -s '300.E2 300.E2' iron
wait $!
./run.sh -p gamma -e '1E5 1E7' -m -2.7 -z '0. 0.' -s '300.E2 300.E2' MRK421-sim-gamma
wait $!
./run.sh -p proton -e '1E5 1E7' -m -2.7 -z '0. 5.' -s '300.E2 300.E2' MRK421-sim-proton
wait $!